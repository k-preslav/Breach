...
public static class ContentLoader
{
    ...
    public static async void Load(ContentType type, string filename)
    {
        string path = "content/";
        if (type is ContentType.Texture)
        {
        ...
        else if (type is ContentType.Font)
        {
        ...
        else if (type is ContentType.Level)
        {
        ...
        else if (type is ContentType.Sound)
        {
        ...
        else if (type is ContentType.Song)
        {
