...
public abstract class UIElement : Sprite
{
            ...
            : base("ui_element", new Vector2(0), textureName, 1, false)
    {
        ...
        this._font = ContentLoader.GetFont(fontName, fontSize);
        _curFontName = fontName;

        base.texture = ContentLoader.GetTexture(base.textureName);
    ...
    public void SetFont(string name)
    {
        ...
        _font = ContentLoader.GetFont(name, curSize);
        _curFontName = name;
    }
    public void SetFontSize(int size)
    {
        _font = ContentLoader.GetFont(_curFontName, size);
    }
